...
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'testingself12@gmail.com', // this is the email that will be used to send the email.
        pass: 'pmuq kqfb rzut bnep', //this is the password that is created in app passwords in gmail setting options.
    },
});
